...
if [ -z "$CHECKERFRAMEWORK" ]; then echo "An error has occured with the checkerframework path"; exit; fi; # Only necessary for Gradle Projects, MVN projects will need a local snapshot. 
