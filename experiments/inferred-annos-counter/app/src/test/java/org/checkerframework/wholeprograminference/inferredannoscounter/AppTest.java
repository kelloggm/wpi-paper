...
public class InferredAnnosCounterTest {
  ...
  /**
  *    This is to setup the outputStreamCaptor before each test to read what printed out by the main method.
  */
  @Before
  public void setUp() {
  ...
  */
  ...
  /**
  *    Test that the main method crashes with a useful error message when invalid input files are supplied.
  *    Depends on the specific error message that is displayed.
  */
  @Test
  ...
  /**
  *    Test that the main method generates the correct output when there are three annotations in the human-written files and three matching ones
  *    in the computer-generated files.
  */
  @Test
  ...
  /**
  *    Test that the main method generates the correct output when there are three annotations in the human-written file and three matching ones
  *    in the computer-generated files, but the @NonNull in the computer-generated file is in a comment. The main method should print out 
  ...
  */
  ...
  /**
  *    Test that the main method generates the correct output when there are three annotations in the human-written file and three matching ones
  *    in the computer-generated files, but the @NonNull in the human-written file is in a comment and in the same line with @Pure, which is not in a comment.
  *    It is like this: "@Pure //@NonNull". The main method should only print out only two annotations.
  */
  @Test
