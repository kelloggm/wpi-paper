...
\newcommand{\numTypeSystems}{\todo{numTypeSystems}\xspace}
\newcommand{\numProjects}{\todo{numProjects}\xspace}
\newcommand{\numLOC}{\todo{some massive number of}\xspace}
\newcommand{\percentInferred}{\todo{percentInferred}\%\xspace}
...
\newcommand{\std}[1]{{\color{gray} #1}}
\newcommand{\qual}[1]{#1}
\newcommand{\infr}[1]{{\color{red} #1}}

\newcommand{\infEnv}{\Xi\xspace}
